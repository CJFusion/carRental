...
require_once(dirname(__DIR__) . '/models/bookings.model.php');
...
class BookingsController
{
	...
	public function __construct()
	{
		...
		$this->endpoint = trim(str_replace('/api/Bookings', '', $_SERVER['REQUEST_URI']), '/');
	}
	...
	{
		$this->endpoint = trim(str_replace('/api/Bookings', '', $endpoint), '/');
	}
